...
<div class="b-personal">
	<div class="b-block">
		...
		<div class="b-personal-top-block">
			...
			<a href="settings.php" class="b-settings-link b-settings-link-desktop">
				<span class="icon-settings"></span>
				<span>Настройки</span>
			</a>
		</div>
	...
	<div class="b-tab-content-container">
		<div class="b-block">
			<div class="b-tab-content" id="loan">
			...
			<div class="b-tab-content hide" id="contribution">
				<div class="b-personal-tile-list">
					<div class="b-personal-tile-item">
						<div class="b-personal-tile-item-string">
			...
			<div class="b-tab-content hide" id="archives">
				<div class="b-personal-tile-list">
					<div class="b-personal-tile-item">
						<div class="b-personal-tile-item-string">
