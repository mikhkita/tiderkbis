...
<div class="b b-content">
	<div class="b-block">
		...
		<div class="b-payments">
			<div class="b-payment">
				<div class="b-payment-img b-payment-img-7" style="background-image: url('i/illustration.svg#7');"></div>
			...
			<div class="b-payment">
				<div class="b-payment-img b-payment-img-8" style="background-image: url('i/illustration.svg#8');"></div>
				<div class="b-payment-text b-text">
